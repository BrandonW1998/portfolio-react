...
const info = [
  {
    ...
    title: "Phone",
    description: "(808) 348-2587",
  },
  {
    icon: <FaEnvelope></FaEnvelope>,
    title: "Email",
    description: "brandon.westbrook98@gmail.com",
  },
  {
    icon: <FaMapMarkedAlt></FaMapMarkedAlt>,
    title: "Address",
    description: "Jacksonville, Florida U.S.A.",
  },
];
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Potential job offers preferably at my phone or email listed.
              </p>
              {/* Input */}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="mst">Position Inquiry</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* Textarea */}
